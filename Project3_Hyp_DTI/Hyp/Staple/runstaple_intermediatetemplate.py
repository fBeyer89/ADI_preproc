...
out_dir = '/nobackup/aventurin4/data_fbeyer/multiatlas/intermediate_template/labelfusionout/staple/'
...
info = dict(
    atlas_input=[['nobackup/aventurin4/data_fbeyer/','','multiatlas/intermediate_template/output/warpedhyp_per_subject/','target_id','','/merged/anat_merged.nii.gz']],
    hyp_input=[['nobackup/aventurin4/data_fbeyer/','multiatlas/intermediate_template/output/warpedhyp_per_subject/','target_id','/merged/','hemi','_merged.nii.gz']],
