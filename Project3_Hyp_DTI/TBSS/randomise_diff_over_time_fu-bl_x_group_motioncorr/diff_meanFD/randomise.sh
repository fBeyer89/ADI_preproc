...
scripts_dir="/data/pt_02161/Analysis/Project3_Hyp_DTI/TBSS/randomise_diff_over_time_fu-bl_x_group_motioncorr/diff_meanFD"

### create logfile for randomise ###
date=$(date)

echo "############################" >> $logfiles/randomise_diff_over_time_fu-bl_x_group_motioncorr_diff_meanFD.log
echo "########## $date ###########" >> $logfiles/randomise_diff_over_time_fu-bl_x_group_motioncorr_diff_meanFD.log
echo "############################" >> $logfiles/randomise_diff_over_time_fu-bl_x_group_motioncorr_diff_meanFD.log
...
echo "##### run tbss randomise: FU-BL x group motion corrected (diff meanFD) #####"
echo "##### run tbss randomise: FU-BL x group motion corrected (diff meanFD) #####" >> $logfiles/randomise_diff_over_time_fu-bl_x_group_motioncorr_diff_meanFD.log


cd $stats_dir 
randomise -i all_fu-bl_skeletonised_eroded.nii.gz -o diff_over_time_fu-bl_x_group_motioncorr/diff_meanFD/two_samples_ttest -d $scripts_dir/design.mat -t $scripts_dir/contrasts.con -n 5000 --T2 -x --uncorrp >> $logfiles/randomise_diff_over_time_fu-bl_x_group_motioncorr_diff_meanFD.log
