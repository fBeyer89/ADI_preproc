...
def create_resting():
    ...
    (transform_ts, reorient2std_mask, [('outputnode.comb_mask_resamp', 'in_file')]),
    ...
    func_preproc.connect([
    (reorient2std_mask, postprocess, [('out_file', 'inputnode.brain_mask')]),#use the correctly oriented mask                           
    (ica_aroma, postprocess,    [('nonaggr_denoised_file', 'inputnode.epi_coreg')]), #use the nonaggr_denoised_file
